...
4. GA4 is configured with measurement ID `G-2W7CWEFM0E`. Add Google Search Console, Bing, and Yandex verification snippets to `index.html` when those accounts are ready.
